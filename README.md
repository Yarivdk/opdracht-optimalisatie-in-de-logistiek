...
1. Maintain parallel implementations in both `hexaly/` and `simulatedAnnealing/` directories
2. Update instance generators if adding new problem parameters
3. Extend graph generation scripts to visualize new metrics
4. Update GitHub Actions workflows if modifying file paths or execution commands
